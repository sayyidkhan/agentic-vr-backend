...
class Settings(BaseSettings):
    ...
    voice_registry_path: str = Field(default="app/data/voice_registry.json", alias="VOICE_REGISTRY_PATH")
    ...
    ytdlp_cookies_file: Optional[str] = Field(default=None, alias="YTDLP_COOKIES_FILE")
    ytdlp_user_agent: Optional[str] = Field(default=None, alias="YTDLP_USER_AGENT")
    ytdlp_pot_provider_base_url: Optional[str] = Field(default=None, alias="YTDLP_POT_PROVIDER_BASE_URL")
